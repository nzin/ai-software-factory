...
func (o *GetRunOK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/runs/{id}][%d] getRunOK %s", 200, payload)
}
...
func (o *GetRunOK) GetPayload() *models.Run {
	return o.Payload
}
...
func (o *GetRunNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /v1/runs/{id}][%d] getRunNotFound %s", 404, payload)
}
...
func (o *GetRunNotFound) GetPayload() *models.Error {
	return o.Payload
}
...
func (o *GetRunDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /v1/runs/{id}][%d] getRun default %s", o._statusCode, payload)
}
...
func (o *GetRunDefault) GetPayload() *models.Error {
	return o.Payload
}
