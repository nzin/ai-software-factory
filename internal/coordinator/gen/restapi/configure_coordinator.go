...
func configureFlags(api *operations.CoordinatorAPI) {
	// api.CommandLineOptionsGroups = []cmdutils.CommandLineOptionsGroup{ ... }
	_ = api
}

func configureAPI(api *operations.CoordinatorAPI) http.Handler {
	...
	if api.RunsSubmitPRDHandler == nil {
		api.RunsSubmitPRDHandler = runs.SubmitPRDHandlerFunc(func(params runs.SubmitPRDParams) middleware.Responder {
			_ = params
