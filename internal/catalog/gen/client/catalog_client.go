...
import (
	...
	"github.com/nzin/ai-software-factory/internal/catalog/gen/client/health"
)

// Default catalog HTTP client.
...
// NewHTTPClient creates a new catalog HTTP client.
func NewHTTPClient(formats strfmt.Registry) *Catalog {
	return NewHTTPClientWithConfig(formats, nil)
}

// NewHTTPClientWithConfig creates a new catalog HTTP client,
// using a customizable transport config.
func NewHTTPClientWithConfig(formats strfmt.Registry, cfg *TransportConfig) *Catalog {
...
func New(transport runtime.ContextualTransport, formats strfmt.Registry) *Catalog {
	// ensure nullable parameters have default
	if formats == nil {
...
// Catalog is a client for catalog.
type Catalog struct {
...
func (c *Catalog) SetTransport(transport runtime.ContextualTransport) {
