...
func (o *DeleteAgentNoContent) Error() string {
	return fmt.Sprintf("[DELETE /v1/agents/{role}][%d] deleteAgentNoContent", 204)
}
...
func (o *DeleteAgentNotFound) Error() string {
	...
	return fmt.Sprintf("[DELETE /v1/agents/{role}][%d] deleteAgentNotFound %s", 404, payload)
}
...
func (o *DeleteAgentDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /v1/agents/{role}][%d] deleteAgent default %s", o._statusCode, payload)
}
...
func (o *DeleteAgentDefault) GetPayload() *models.Error {
	return o.Payload
}
